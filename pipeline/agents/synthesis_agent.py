...
# ──────────────────────────
# Takes the research + pattern output and writes the full report.
# The tone must walk the line between technical and accessible —
# and crucially, must sound like a *person* wrote it.
# """
...
# SYSTEM = """You are a senior technology journalist who has written for publications like Wired, MIT Tech Review,
# and The Atlantic. You make complex topics genuinely interesting — not by dumbing them down,
# but by finding the human angle, the stakes, and the story.
...
#   "at the intersection of", "game-changing", "paradigm shift"
...
# 2. A 2-3 sentence opening that hooks the reader immediately — no scene-setting, no history
# 3. ## What's Actually Happening Right Now
# 4. ## The Voices Shaping the Conversation
# 5. ## What Everyone's Missing (this is the most valuable section — lead with the gaps)
# 6. ## What This Means If You're [technical role] / What This Means If You're [non-technical role]
#    (split the implications by audience type so both feel served)
# 7. ## The Bottom Line (3-5 sentences of sharp synthesis — what to watch, what to do)

# Length: 900-1400 words. Dense enough to be useful. Tight enough to finish.
...
#     Returns a full markdown string — the draft report.
#     """
...
#     # Build a focused brief for Claude
#     brief = {
#         "domain": domain,
...
#     log("✅ Synthesis Agent complete — draft written")
#     return draft
